...
// Supabase errors are plain objects, not Error instances, so String(e) on one
// yields the useless "[object Object]". Every throw in this file re-throws the
// raw Supabase error, so anything catching them needs this to say anything
// meaningful. Kept here rather than in a util because this is where the raw
// errors originate.
export function errorText(e: unknown): string {
  if (e instanceof Error) return e.message
  if (e && typeof e === 'object') {
    const o = e as Record<string, unknown>
    const bits = [o.message, o.details, o.hint, o.code]
