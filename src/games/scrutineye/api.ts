...
export const SCENE_LABEL: Record<string, string> = {
  ...
  amusement: 'Amusement Park', excavation: 'Excavation Site', atlantis: 'Atlantis', castle: 'Feudal Castle',
  bazaar: 'Global Bazaar', lostcity: 'Lost City', museum: 'The Museum', spacelab: 'Space Lab', toyshop: 'Toy Shop',
}
