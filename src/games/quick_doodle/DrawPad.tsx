      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`pf-glass rounded-card px-3 py-2 text-sm ${!erasing ? 'ring-2 ring-cyan' : ''}`}
          ...
          <button
            ...
            aria-pressed={erasing}
          >🧽 Eraser</button>
          <button onClick={undo} className="pf-glass rounded-card px-3 py-2 text-sm">Undo</button>
          <button onClick={clear} className="pf-glass rounded-card px-3 py-2 text-sm">Clear</button>
        </div>
      </div>
    </div>
  )
