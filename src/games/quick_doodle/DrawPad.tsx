...
export function DrawPad({
  ...
  const [ink, setInk] = useState('#111827') // start on black — clearest on the white canvas
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-2">
      <div
        ...
        style={{ aspectRatio: '4 / 3', maxHeight: '48vh', maxWidth: 'calc(48vh * 4 / 3)' }}
      >
        <canvas
          ref={ref}
          onPointerDown={down}
...
// 8 basic drawing colours (single row, fits every phone).
function PALETTE(_own: string): string[] {
  return ['#111827', '#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#a855f7', '#8b5a2b']
}
