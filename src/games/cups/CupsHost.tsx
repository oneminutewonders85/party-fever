...
function Sequence({ theme, colors, orientation, size = 170 }: { theme: string; colors: string[]; orientation: 'h' | 'v'; size?: number }) {
  return (
  ...
  return (
    <div className="flex min-h-[86vh] flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center text-center">
        ...
        <p className="mb-10 pf-wordmark text-4xl text-white">Match this on your phone, then BUZZ!</p>
        <Sequence theme={cu.theme} colors={cu.target} orientation={cu.orientation} />
        {!reveal && <div className="mt-10 flex justify-center"><TimerRing seconds={remaining} /></div>}
        {reveal && (
          <p className="mt-10 pf-wordmark text-5xl text-p-lime">
