...
// The wheel's CSS transition. Phone and TV both gate their reveal on this, so
// nobody learns the outcome before the wheel visibly lands on it.
export const SPIN_ANIM_MS = 3400
